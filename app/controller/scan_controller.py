        ...
        for col in range(cols):
            ...
            for row in row_range:
                ...
                if not is_last_tile_in_col:
                    ...
                    self.navigator.forward_distance(speed=0.3, distance_meters=self.tile_size)
                    time.sleep(0.5)
            ...
            if col < cols - 1:  # Don't turn after the last row
                ...
                self.navigator.forward_distance(speed=0.2, distance_meters=0.10)
                time.sleep(0.5)
                
                if is_going_down:
                    self.navigator.turn_right_90()
                    time.sleep(0.5)
                    self.navigator.forward_distance(speed=0.2, distance_meters=self.tile_size - 0.05)
                    time.sleep(0.5)
                    self.navigator.turn_right_90()
                else:
                ...
                time.sleep(0.5)
                self.navigator.forward_distance(speed=0.2, distance_meters=-0.13)
                time.sleep(0.5)
